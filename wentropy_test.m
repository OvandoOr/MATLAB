...
%EntropyROM(o) = wentropy(nano(o,x),'shannon');
%EntropyROM(o) = sum(-(hHist2(hHist2>0)).*(log2(hHist2((hHist2(hHist2>0))))));
...
% Entropia_gel=mean(Entro_fin);
% Entropia_nano=mean(Entro_fin1);
...
% xlabel(['Entropia gel = ' ,num2str(Entropia_gel), '  Entropia nano = ' ,num2str(Entropia_nano), '  Porcentaje de mejora = % ' ,num2str(Porcentaje_de_mejora)])
% ylabel('Entropia')
