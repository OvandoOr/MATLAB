...
imagen_media(:,:,1)=medfilt2(imagen_original(:,:,1),[3 3]);
imagen_media(:,:,2)=medfilt2(imagen_original(:,:,2),[3 3]);
imagen_media(:,:,3)=medfilt2(imagen_original(:,:,3),[3 3]);
...
imagen_bin=(hue >= .37)&(hue <= .58)&(saturacion > .4)&(im_rojo < .5*255);
