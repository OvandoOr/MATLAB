...
MW='sym5';                           % Wavelet basis function
...
sig_graph=zeros(1,round(cantidad_ciclos*per2/16));
sig_graph((per*.5)+1:end)=normal;
 figure,
 %subplot(2,1,1)
 plot(1:cantidad_ciclos*per2,ecg_analog(1:cantidad_ciclos*per2))
 hold on
 %subplot(2,1,2)
