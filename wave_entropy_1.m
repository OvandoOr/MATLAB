...
EntropyROM4(1:6)=EntropyDrug;%creamos un vector con el mismo valor para que en la grafica aparezca como una linea recta
...
for wave=1:3 %este for selecciona la ondoleta madre
    ...
    for o =1:6 %numero de niveles de descomposicion para las repeticiones
        ...
        %plot(1:2^o:sig_b*2^o,sig_level+(o*10000)) %lo mismo de arriba pero con las señales mas separadas para comparar mas facil
...
%         ylabel('Tasa de incidencia')
        ...
        hold on
        plot (y) %grafica señal reconstruida
