...
imagen_media(:,:,1)=medfilt2(imagen_original(:,:,1),[12 12]);
imagen_media(:,:,2)=medfilt2(imagen_original(:,:,2),[12 12]);
imagen_media(:,:,3)=medfilt2(imagen_original(:,:,3),[12 12]);
...
imagen_bin=(hue >= .777)&(hue <= .888)&(saturacion > .5)&(im_azul > .4*255);
